...
var sports = require('./routes/admin/sports');
var gallaries = require('./routes/admin/gallaries');
...
//});
app.use('/', front);//TypeError: Cannot read property 'query' of undefined
app.use('/front', front);
